...
class MyAgent(ACTR):
    ...
    DMbuffer=Buffer()                   
    DM=Memory(DMbuffer,latency=0.05,threshold=3)     # latency controls the relationship between activation and recall
    ...
    dm_spread.strength=3                           # set strength of activation for buffers
    ...
    def init():
        DM.add('customer:customer condiment:mayo')
